...
## Convert Use.of.Funds to features that are useable in regression using LSA
...
(svmTestMisclassification = 1 - mean(svmPred == test$Payment.Status)) 
table(svmPred) # Still all current. Same as baseline
...
# Very closely related, indicating that Interest.rate was and Credit.rating were both constructed from the same model
